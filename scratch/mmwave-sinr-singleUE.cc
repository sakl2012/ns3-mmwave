...
static ns3::GlobalValue g_x_UE ("x", "Distance between UE and eNB (m)",
...
main (int argc, char *argv[])
{
  ...
  GlobalValue::GetValueByName ("x", doubleValue);
  double x = doubleValue.Get ();\
  ...
  uePositionAlloc->Add (Vector (x, 0.0, 0.0));
  ...
  Simulator::Stop (Seconds (0.00012525));
  Simulator::Run ();
  Simulator::Destroy ();
  return 0;
}
